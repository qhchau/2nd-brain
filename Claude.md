...
2. Check for:
   ...
   - **Log coverage:** any wiki page whose frontmatter `sources` list is non-empty should correspond to at least one log entry in `wiki/.system/log.md`. Flag pages where no matching log entry exists (indicates an ingest happened without logging).
...
Each entry:
```markdown
- [Page Title](path/to/page.md) — one-line summary | tags: tag1, tag2 | sources: filename1.md, filename2.md
```

Example:
```markdown
## Projects
- [Nissan SubAmp Thermal Simulation](nissan-subamp-project.md) — thermal model for SubAmp assembly, delivery target Apr 8 | tags: nissan, thermal, ansys | sources: raw/2026-04-01_daily-scan.md, raw/meeting-2026-04-05.md

## People
- [Ross Hanson](ross-hanson.md) — thermal simulation colleague, works on SubAmp and other Nissan projects | tags: colleague | sources: raw/2026-04-01_daily-scan.md, raw/meeting-2026-04-05.md, raw/email-scan.md
```
